...
Use the [root README](../README.md), [local setup](../docs/LOCAL_SETUP.md) and [current coverage](../docs/REQUIREMENTS.md). The worker now also supports revisioned human reviews and DOCX. Hardware/model installation statements and measurements below describe the earlier deployment; those assets are not present or revalidated in a fresh clone.
