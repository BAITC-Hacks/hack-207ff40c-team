...
Historical README from upstream 849f222. Claims and commands below refer to the earlier appliance deployment; use the current root README for this submission.
