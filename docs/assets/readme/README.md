...
с настоящими локальными сервисами станции и вычислителя. Снимки обновлены 23 сентября 2026 года после русификации интерфейса.
Импорт и проверка сняты целиком как отдельные панели; остальные снимки
показывают страницы приложения. Проверены также мобильная ширина 390 пикселей
и тёмное оформление.
