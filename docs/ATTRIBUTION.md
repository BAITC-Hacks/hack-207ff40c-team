...
Русификация и оформление интерфейса используют существующие компоненты и
установленные значки lucide-react. Новые библиотеки, шрифты или внешние ресурсы
не добавлялись. Четыре снимка пересняты после обновления интерфейса.
